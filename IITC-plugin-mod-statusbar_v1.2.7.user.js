...
// @description    [1.2.7]ステータスバーに、装着MODの略号を色付き・スロット位置固定で表示する。挿入位置は「ポータルレベル/XMエネルギーの前」と「その後・ポータル名の前」から選択可能。ON/OFFトグル、略号・色・空欄文字のユーザーカスタマイズに対応。IITC.statusbar API の無い旧ビルド (iOS版アプリ等) にもフォールバック対応。設定画面はOKボタン1つで反映・閉じるを行う。
...
function wrapper(plugin_info) {
    ...
    self.showSettings = function () {
        ...
        var html = '' +
            ...
            'OFF = 「L8 100%,MOD,MOD,MOD,MOD,ポータル名」。</p>';
